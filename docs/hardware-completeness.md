...
interpreter replays match byte-for-byte with zero unsupported RMT or common
Arduino-S3 startup sites. The digital envelope follows guest-clock thresholds;
